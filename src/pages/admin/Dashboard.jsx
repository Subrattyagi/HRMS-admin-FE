...
export default function Dashboard() {
  ...
  const stats = [
    { label: 'Total Employees', value: '245', className: 'blue' },
    { label: 'Present Today', value: '198', className: 'green' },
    { label: 'Absent Today', value: '32', className: 'red' },
    { label: 'On Leave', value: '15', className: 'orange' },
  ]
