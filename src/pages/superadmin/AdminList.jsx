...
export default function AdminList() {
  const admins = [
    { id: 1, name: 'Admin User', email: 'admin@frostrek.com', company: 'FrosTrek AI', role: 'ADMIN', joinDate: '01 Jan 2024' },
    { id: 2, name: 'Super Admin User', email: 'super@frostrek.com', company: 'FrosTrek AI', role: 'SUPER_ADMIN', joinDate: '01 Jan 2024' },
